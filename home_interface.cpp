...
#include "../components/lcars_soliddeco.hh"
...
class HomeInterface : public LCARS::Interface {
    ...
    private:
        ...
        LCARS::SolidDeco * m_sld_dco1;
        LCARS::SolidDeco * m_sld_dco2;
        LCARS::SolidDeco * m_sld_dco3;
        LCARS::SolidDeco * m_sld_dco4;
        LCARS::SolidDeco * m_sld_dco5;
        LCARS::SolidDeco * m_sld_dco6;
        LCARS::SolidDeco * m_sld_dco7;
        LCARS::SolidDeco * m_sld_dco8;
        LCARS::SolidDeco * m_sld_dco9;
        LCARS::SolidDeco * m_sld_dco10;
        LCARS::SolidDeco * m_sld_dco11;
        LCARS::SolidDeco * m_sld_dco12;


        LCARS::BigDeco * m_topleft_deco;
        LCARS::BigDeco * m_botleft_deco;
    ...
    public:
            HomeInterface(int x, int y, int width, int height) : Interface(x, y, width, height) {
                ...
                m_lfont   = new LCARS::Font(fontpath, 26);
                m_font  = TTF_OpenFont(fontpath.c_str(), 26);
                ...
                m_btn_reboot = new LCARS::ButtonRounded(0, 0, 10, button_height*hp, m_lfont, "Reboot");
                m_btn_reboot->SetRoundLeft(false);
                m_btn_reboot->SetRoundRight(false);

                m_btn_shutdown = new LCARS::ButtonRounded(0, 0, 10, button_height*hp, m_lfont, "Shutdown");
                m_btn_shutdown->SetRoundLeft(false);
                m_btn_shutdown->SetRoundRight(false);

                m_btn_lock = new LCARS::ButtonRounded(0, 0, 10, 400*hp, m_lfont, "Lock");
                m_btn_lock->SetRoundLeft(false);
                m_btn_lock->SetRoundRight(false);

                m_btn_external = new LCARS::ButtonRounded(0, 0, 10, button_height*hp, m_lfont, "External");
                m_btn_external->SetRoundLeft(false);
                m_btn_external->SetRoundRight(false);

                m_btn_systems = new LCARS::ButtonRounded(0, 0, 10, button_height*hp, m_lfont, "Systems");
                m_btn_systems->SetRoundLeft(false);
                m_btn_systems->SetRoundRight(false);

                m_btn_database = new LCARS::ButtonRounded(0, 0, 10, 355*hp, m_lfont, "Database");
                ...
                m_btn_unused1 = new LCARS::ButtonRounded(0, 0, 10, button_height*hp, m_lfont, "0012-A");
                m_btn_unused1->SetRoundLeft(false);
                m_btn_unused1->SetRoundRight(false);

                m_btn_unused2 = new LCARS::ButtonRounded(0, 0, 10, button_height*hp, m_lfont, "0012-B");
                m_btn_unused2->SetRoundLeft(false);
                m_btn_unused2->SetRoundRight(false);

                m_btn_unused3 = new LCARS::ButtonRounded(0, 0, 10, 121*hp, m_lfont, "0012-C");
                ...
                m_btn_unused4 = new LCARS::ButtonRounded(0, 0, 10, (button_height + 27)*hp, m_lfont, "0013-A");
                m_btn_unused4->SetRoundLeft(false);
                m_btn_unused4->SetRoundRight(false);

                m_btn_unused5 = new LCARS::ButtonRounded(0, 0, 10, button_height*hp, m_lfont, "0013-B");
                m_btn_unused5->SetRoundLeft(false);
                m_btn_unused5->SetRoundRight(false);

                m_btn_unused6 = new LCARS::ButtonRounded(0, 0, 10, button_height*hp, m_lfont, "0013-C");
                m_btn_unused6->SetRoundLeft(false);
                m_btn_unused6->SetRoundRight(false);

                m_btn_unused7 = new LCARS::ButtonRounded(0, 0, 10, 255*hp, m_lfont, "0013-D");
                m_btn_unused7->SetRoundLeft(false);
                m_btn_unused7->SetRoundRight(false);

                m_btn_unused8 = new LCARS::ButtonRounded(0, 0, 10, button_height*hp, m_lfont, "0013-E");
                m_btn_unused8->SetRoundLeft(false);
                m_btn_unused8->SetRoundRight(false);

                m_btn_unused9 = new LCARS::ButtonRounded(0, 0, 10, button_height*hp, m_lfont, "0013-F");
